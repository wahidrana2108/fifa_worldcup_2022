<ul class='navbar-nav navbar-dark bg-dark ps-3 pe-3'>
    ...
    <li class='nav-item '><a class='nav-link active text-light' aria-current='page' href='my_account.php?view_account'><i class='fa-solid fa-pen-to-square pe-3'></i> View Details</a></li>
    ...
    <li class='nav-item '><a class='nav-link active text-light' aria-current='page' href='my_account.php?'><i class='fa-solid fa-key pe-3'></i> Edit Password</a></li>
